    ...
    <section className="py-16 bg-[#FAF9F6]" id="contact">
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-700 max-w-2xl mx-auto leading-relaxed text-sm">
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-stretch">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-white rounded-2xl border border-[#d4ecd4] shadow-sm hover:shadow-md transition-shadow">
                  <div>
                    <p className="text-xs font-mono text-slate-700 uppercase tracking-widest mb-1">Amharic Support</p>
                ...
                <div className="flex items-center justify-between p-4 bg-white rounded-2xl border border-[#d4ecd4] shadow-sm hover:shadow-md transition-shadow">
                  <div>
                    <p className="text-xs font-mono text-slate-700 uppercase tracking-widest mb-1">Afaan Oromoo Support</p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 pt-4 border-t border-[#d4ecd4]/60">
              <div className="bg-white p-5 rounded-2xl border border-[#d4ecd4]">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-bold text-obsidian text-sm">Piasa Store</h4>
                </div>
                <p className="text-sm text-slate-700 mb-3 leading-relaxed">
                  Addis Ababa, Piazza Giorgis, Ethel Appartment
                </p>
                <a href="https://maps.app.goo.gl/mssptHZ9dAXRCbCh7" className="inline-flex items-center gap-1.5 text-xs font-mono font-bold uppercase tracking-wider text-highland-gold hover:text-highland-gold-light transition-colors">
              ...
              <div className="bg-white p-5 rounded-2xl border border-[#d4ecd4]">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-bold text-obsidian text-sm">Main Office</h4>
                </div>
                <p className="text-sm text-slate-700 mb-3 leading-relaxed">
                  Jemo Mickael Woreda 03,Africa Building, Addis Ababa, Ethiopia
                </p>
                <a href="https://maps.app.goo.gl/qUfZBHcAL2784skT6?g_st=ic" className="inline-flex items-center gap-1.5 text-xs font-mono font-bold uppercase tracking-wider text-highland-gold hover:text-highland-gold-light transition-colors">
          ...
          <div className="bg-obsidian rounded-[32px] p-6 md:p-8 text-white shadow-xl flex flex-col justify-center border border-highland-gold/20 relative overflow-hidden">
            ...
            <form className="space-y-4 relative z-10" onSubmit={handleSubmit}>
              ...
              <div>
                <label className="block text-xs font-mono font-bold text-highland-gold uppercase tracking-widest mb-1.5 ml-1">Full Name *</label>
                <input 
                  type="text" 
                  required
                  ...
                  className="w-full px-4 py-2.5 bg-obsidian-mid/50 border border-highland-gold/20 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-highland-gold/50 focus:border-highland-gold transition-all text-sm font-sans" 
                />
              </div>

              <div>
                <label className="block text-xs font-mono font-bold text-highland-gold uppercase tracking-widest mb-1.5 ml-1">Phone Number *</label>
                <input 
                  type="tel" 
                  required
                  ...
                  className="w-full px-4 py-2.5 bg-obsidian-mid/50 border border-highland-gold/20 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-highland-gold/50 focus:border-highland-gold transition-all text-sm font-mono" 
                />
              </div>

              <div>
                <label className="block text-xs font-mono font-bold text-highland-gold uppercase tracking-widest mb-1.5 ml-1">Email Address (Optional)</label>
                <input 
                  type="email" 
              ...
              <div>
                <label className="block text-xs font-mono font-bold text-highland-gold uppercase tracking-widest mb-1.5 ml-1">Preferred Date *</label>
                <input 
                  type="date" 
                  required
                  value={formData.preferred_date}
                  onChange={e => setFormData(p => ({...p, preferred_date: e.target.value}))}
                  className="w-full px-4 py-2.5 bg-obsidian-mid/50 border border-highland-gold/20 rounded-xl text-white focus:outline-none focus:ring-1 focus:ring-highland-gold/50 focus:border-highland-gold transition-all text-sm font-mono [color-scheme:dark]" 
                />
              </div>
              ...
              <div className="pt-2">
                <button 
                  type="submit" 
                  disabled={loading}
                  className="w-full py-3 bg-highland-gold hover:bg-highland-gold-light text-obsidian font-mono font-bold rounded-xl transition-all duration-300 flex items-center justify-center gap-2 text-sm uppercase tracking-widest shadow-lg hover:shadow-highland-gold/25 disabled:opacity-50 disabled:cursor-not-allowed"
                >
